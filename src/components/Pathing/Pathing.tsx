...
import { Container, TreeContainer, MainBranch, BranchLine, BranchContent, BranchTitle, BranchSubtitle, BranchDescription, CTAButton, TextContainer } from './styles';
      ...
      {!showBooking ? (
        <>
          ...
          <TreeContainer>
            ...
            <CTAButton onClick={() => setShowBooking(true)}>
              ¿Comenzamos?
            </CTAButton>
          </TreeContainer>
        </>
      ) : (
        <TextContainer style={{ width: '100%', display: 'flex', justifyContent: 'center', paddingTop: '2rem' }}>
          <iframe
