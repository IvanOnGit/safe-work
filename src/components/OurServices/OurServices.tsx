...
import { Container, ServiceCard, IconWrapper, Title, List, TextContainer } from './styles';

function OurServices() {
    return (
        <>
            <TextContainer>
                <h1>Analisamos tu caso para saber cuál de nuestros <br /> servicios se adapta mejor a tu situación</h1>
            </TextContainer>
            <Container>
                <ServiceCard>
                    <IconWrapper>
