  ...
  return (
    <Container>
        ...
        <InnerText>
            ...
            <p>
            Miguel Pérez Urzay , en aplicación de la normativa vigente en materia de protección de datos de carácter personal,
            informa que los datos personales que se recogen a través de los formularios del Sitio web:
            https://ayudaacosolaboral.com, se incluyen en los ficheros automatizados específicos de usuarios de los servicios de
            Miguel Pérez Urzay 
            ...
            Miguel Pérez Urzay  adopta las medidas necesarias para garantizar la seguridad, integridad y confidencialidad de los
            ...
            usuario a través de email a: mperez.psicologia@gmail.com o en la dirección: Paseo De La Alameda De Osuna 81. 2d.,
            C.P. 28042 - Madrid  (Madrid).
            El usuario manifiesta que todos los datos facilitados por él son ciertos y correctos, y se compromete a mantenerlos
            actualizados, comunicando los cambios a Miguel Pérez Urzay
              </p>
              <h2>Finalidad del tratamiento de los datos personales:</h2>
              <h3>¿Con qué finalidad trataremos tus datos personales?</h3>
              <p>
              En Miguel Pérez Urzay , trataremos tus datos personales recabados a través del Sitio Web:
                https://ayudaacosolaboral.com, con las siguientes finalidades: <br />
                1. Dar cumplimiento de las obligaciones, comerciales, laborales, corporativas y contables de la empresa. <br />
                2. Prestar sus servicios de acuerdo con las necesidades particulares de los clientes, con el fin de cumplir
                los contratos suscritos por la misma.<br />
                3. Enviar información promocional vía electrónica.<br />
                4. Facilitar la información solicitada por el usuario a través del formulario de contacto.<br />
              ...
              <p> El tratamiento de tus datos se realiza con las siguientes bases jurídicas que legitiman el mismo:<br />
                1. La solicitud de información y/o la contratación de los servicios de Miguel Pérez Urzay , cuyos términos <br />
                y condiciones se pondrán a tu disposición en todo caso, de forma previa a una eventual contratación.<br />
                ...
                de una casilla dispuesta al efecto. <br />
              ...
              <h2>Destinatarios:</h2>
              <p>Los datos no se comunicarán a ningún tercero ajeno a Miguel Pérez Urzay , salvo obligación legal</p>
              ...
              compartido, Miguel Pérez Urzay  no se hace responsable del incumplimiento por parte del usuario del RGPD.</p>
              <h2> Derechos propiedad intelectual https://ayudaacosolaboral.com</h2>
              <p>
                Miguel Pérez Urzay  es titular de todos los derechos de autor, propiedad intelectual, industrial, "know how" y cuantos
                otros derechos guardan relación con los contenidos del sitio web https://ayudaacosolaboral.com y los servicios
                ...
                sitio web https://ayudaacosolaboral.com sin el consentimiento previo y por escrito.
              </p>
              <h2> Propiedad intelectual del software</h2>
              <p>
                El usuario debe respetar los programas de terceros puestos a su disposición por Miguel Pérez Urzay , aún siendo
                gratuitos y/o de disposición pública.
                Miguel Pérez Urzay  dispone de los derechos de explotación y propiedad intelectual necesarios del software.
                ...
                de Miguel Pérez Urzay , quedando prohibido al usuario acceder, modificar, visualizar la configuración, estructura y
                ficheros de los servidores propiedad de Miguel Pérez Urzay , asumiendo la responsabilidad civil y penal derivada de
              ...
              <p>
                Se prohíbe el uso contrario a la legislación sobre propiedad intelectual de los servicios prestados por Miguel Pérez
                Urzay  y, en particular de: <br />
                •  La utilización que resulte contraria a las leyes españolas o que infrinja los derechos de terceros.<br />
                •  La publicación o la transmisión de cualquier contenido que, a juicio de Miguel Pérez Urzay , resulte
                violento, obsceno, abusivo, ilegal, racial, xenófobo o difamatorio.<br />
                ...
                El usuario indemnizará a Miguel Pérez Urzay  por los gastos que generara la imputación de Miguel Pérez Urzay  en
              ...
              <p>
                Miguel Pérez Urzay  realiza copias de seguridad de los contenidos alojados en sus servidores, sin embargo no se
                ...
                conservados en las copias de seguridad realizadas por Miguel Pérez Urzay , cuando esta pérdida sea imputable al
                ...
                a causas atribuibles a Miguel Pérez Urzay.
              </p>
              <h2> Comunicaciones comerciales</h2>
              <p>
                En aplicación de la LSSI. Miguel Pérez Urzay  no enviará comunicaciones publicitarias o promocionales por correo
                ...
                En el caso de usuarios con los que exista una relación contractual previa, Miguel Pérez Urzay  sí está autorizado al
                envío de comunicaciones comerciales referentes a productos o servicios de Miguel Pérez Urzay  que sean similares a
