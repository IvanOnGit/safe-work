  ...
  return (
    <Container>
        ...
        <InnerText>
            ...
            obtengan se pueden distinguir dos tipos: <br />
            •    Cookies propias: <br />
            ...
            cliente, pudiendo tratarse de:<br />
            ...
            definido por el responsable de la cookie, y que puede ir de unos minutos a varios años.<br />
            ...
            regula por la política de privacidad de la plataforma social correspondiente. <br />           
            </p>
            ...
            del navegador instalado en su ordenador: <br />
            ...
            <h2>Cookies utilizadas en https://ayudaacosolaboral.com</h2>
            <p>
            A continuación se identifican las cookies que están siendo utilizadas en este portal así como su tipología y función: <br />
            •   _gcl_au<br />
            -   Duración: 3 meses <br />
            -   Descripción: Almacenar y realizar un seguimiento de las conversiones.<br />
            -   Tipo: Tercero<br />
            -   Finalidad: Analítica<br />
            •   __Secure-ENID<br />
            -   Duración: 1 año<br />
            -   Descripción: Cookie necesaria para la utilización de las opciones y servicios del sitio web<br />
            -   Tipo: Tercero <br />
            -   Finalidad: Técnica <br />
            •   AEC <br />
            -   Duración: 6 meses <br />
            -   Descripción: Cookie necesaria para la utilización de las opciones y servicios del sitio web <br />
            -   Tipo: Tercero <br />
            ...
            •   DV<br />
            -   Duración: sesión<br />
            -   Descripción: Identifica al usuario si está logueado con su cuenta de Google<br />
            -   Tipo: Tercero<br />
            -   Finalidad: Técnica<br />
            •   SOCS<br />
            -   Duración: 13 meses<br />
            -   Descripción: Para almacenar el estado de un usuario respecto a sus elecciones de cookies<br />
            -   Tipo: Tercero<br />
            -   Finalidad: Técnica<br />
            </p>
            <h2> Aceptación de la Política de cookies</h2>
            <p>
            https://ayudaacosolaboral.com, asume que usted acepta el uso de cookies. No obstante, muestra información sobre su
            ...
            de que usted sea consciente.<br />
            ...
            https://ayudaacosolaboral.com y modificar la configuración de su navegador.
            </p>
        </InnerText>
    </Container>
  );
